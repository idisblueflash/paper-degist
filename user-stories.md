...
| [US 40](user-stories/us-40-browser-fetch-lazyload-interactive-wall.md) | Capture lazy-loaded full-text through an interactive wall (ScienceDirect) | `browser-fetch`   | 📋 Spec                           |
